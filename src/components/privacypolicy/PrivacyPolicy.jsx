...
const PrivacyPolicy = () => {
  return (
    <section
      ...
      className="py-5 privacy-banner"
    >
      <Container className="mt-5 text-white">
        <h1>Privacy Policy for Madadz</h1>
        <hr />
        <div className="py-2 text-white policy-content">
          ...
          <h2 className="heading">Interpretation and Definitions</h2>
          <h3 className="heading-2">Interpretation</h3>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to madadz.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to madadz, accessible from{" "}
                <a
                  href="https://mad-adz.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://mad-adz.vercel.app/
                </a>
              </p>
            </li>
            <li>
          ...
          <h2 className="heading">Collecting and Using Your Personal Data</h2>
          <h3 className="heading-2">Types of Data Collected</h3>
          <h4 className="heading-4">Personal Data</h4>
          <p>
          ...
          <p>
            ...
            the{" "}
            <a href="https://mad-adz.vercel.app/" target="_blank">
          ...
          <h3 className="heading-2">Use of Your Personal Data</h3>
          ...
          <h3 className="heading-2">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="heading-2">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="heading-2">Disclosure of Your Personal Data</h3>
          <h4 className="heading-3">Business Transactions</h4>
          <p>
          ...
          <h4 className="heading-3">Law enforcement</h4>
          <p>
          ...
          <h4 className="heading-3">Other legal requirements</h4>
          <p>
          ...
          <h3 className="heading-2">Security of Your Personal Data</h3>
          <p>
          ...
          <h2 className="heading-2">Links to Other Websites</h2>
          <p>
          ...
          <h2 className="heading-2">Changes to this Privacy Policy</h2>
          <p>
          ...
          <ul>
            ...
            <li>By phone number: +91 93616 24563</li>
          </ul>
        </div>
      </Container>
    </section>
